<%-- 
    Document   : modificar-gasto3
    Created on : 3/06/2023, 04:08:52 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup">
                ...
                %>
                <center>
                    <a href="GastoTransporte.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-ing"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
