<%-- 
    Document   : VDesaprobada
    Created on : 23/05/2023, 09:07:37 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup1">
                <center>
                    <br>
                    <span class="subtitulo" style="color: #7972E6 ;">Lo siento!!</span><br><br>
                    <span class="p-txt">El codigo de verificacion es incorrecto</span><br><br>
                    <img src="../IMG/desaprobacion.jpg" alt="Desaprobacion" class="img-ver"><br><br>
                    <a href="Crear-Cuenta.jsp" class="btn-terminar">Terminar</a>
                </center>
            </div>
        </div>
    </body>
