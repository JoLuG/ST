<%-- 
    Document   : GraficoGastos1
    Created on : 2/06/2023, 10:06:33 PM
    Author     : wendy
--%>
    ...
    <body>
                ...
                <center>     
                    <table class="tb-btn-img1">
                        <tr>
                            ...
                            <td>
                                <a href="GraficoGastos.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-btn-img"><i title="Grafico" class="fa-solid fa-chart-column icon-menu1"></i></a>
                            </td>                         
        ...
        <div class="overlay">
            <div class="popup-graficos">
                ...
                <center>
                    <a href="GastoAlimentos.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-graficos"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
                    <span style="color: #FF9B00; font-weight: bold; font-size: 20pt">
                        Grafico Alimentos
                    </span>
                    <br><br>
