<%-- 
    Document   : modificar-gasto2
    Created on : 2/06/2023, 10:41:14 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup">
                ...
                %>
                <center>
                    <a href="GastoRopa.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-ing"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
