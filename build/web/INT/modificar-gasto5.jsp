<%-- 
    Document   : modificar-gasto5
    Created on : 3/06/2023, 05:11:39 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup">
                ...
                %>
                <center>
                    <a href="GastoServicios.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-ing"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
