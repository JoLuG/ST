<%-- 
    Document   : Ingresos
    Created on : 25/05/2023, 12:22:42 PM
    Author     : wendy
--%>
                ...
                <center>     
                    <table class="tb-btn-img1">
                        <tr>
                            ...
                            <td>
                                <a href="GraficoIngresos.jsp?usuario=<%=us.getUsuario()%>" class="a-btn-img"><i title="Grafico" class="fa-solid fa-chart-column icon-menu1"></i></a>
                            </td>                         
