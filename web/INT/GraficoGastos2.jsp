<%-- 
    Document   : GraficoGastos2
    Created on : 2/06/2023, 10:45:39 PM
    Author     : wendy
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../CSS/Gastos-Estilo-ALL2.css">
        <title>Gastos</title>    
    </head>
    <body>
        <%
        ...
        <div class="Cuadro-blanco">
            ...
            <div class="div-derecho">                            
                <br>
                <center>
                    <span class="h1-titulo">Ropa</span>
                </center> 
                ...
                <select name="Descripcion" id="gasto" class="inp-text">               
                    ...
                    <option value="Maquillaje/Skin-care">Maquillaje/Skin-care</option>
                </select> <br><br>
                ...
                <center>     
                    <table class="tb-btn-img1">
                        <tr>
                            ...
                            <td>
                                <a href="GraficoGastos2.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-btn-img"><i title="Grafico" class="fa-solid fa-chart-column icon-menu1"></i></a>
                            </td>                         
                    ...
                    <table class="tb-info-ingresos">
                        ...
                        <tbody>
                            ...
                            <tr class="tr-tbody">
                                ...
                                <td class="td-op-tbody"><a href="modificar-gasto2.jsp?usuario=<%=us.getUsuario()%>&&id=<%=in.get(i).getIdgastos()%>&&tgasto=<%=categoria%>" class="a-btn-img"><i title="Modificar" class="fas fa-edit icon-menu2"></i></a></td>                                
        ...
        <div class="overlay">
            <div class="popup-graficos">
                ...
                <center>
                    <a href="GastoRopa.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-graficos"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
                    <span style="color: #800080; font-weight: bold; font-size: 20pt">
                        Grafico Ropa
                    </span>
                    <br><br>
