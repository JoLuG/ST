<%-- 
    Document   : modificar-gasto
    Created on : 2/06/2023, 09:14:32 PM
    Author     : wendy
--%>
    ...
    <body>
        ...
        <div class="overlay">
            <div class="popup">
                ...
                %>
                <center>
                    <a href="GastoAlimentos.jsp?usuario=<%=us.getUsuario()%>&&tgasto=<%=categoria%>" class="a-exit-ing"><i title="Salir" class="fas fa-times"></i></a>
                    <br><br>
